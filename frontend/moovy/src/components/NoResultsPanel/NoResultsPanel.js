...
export default function NoResultsPanel({message}){
    ...
    return(
        <div className={style.panel}>
            <svg 
                width="200px" 
                height="200px" 
                viewBox="0 0 64 64" /* Adjusted to match the internal dimensions of your SVG */
                preserveAspectRatio="xMidYMid meet" /* Keeps the aspect ratio consistent */
